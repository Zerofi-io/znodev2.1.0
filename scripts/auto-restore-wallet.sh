...
# Load .env to get WALLET_BACKUP_PASSPHRASE (if present)
...
# If not set in the environment, fall back to a passphrase file generated by the node
...
# Find encrypted backups (v2 with MAC, v1 legacy without MAC)
