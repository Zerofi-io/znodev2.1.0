...
class ZNode {
  constructor() {
    ...
    const KNOWN_DEFAULTS = {
      11155111: {
        REGISTRY_ADDR: '0x9D434bae96B4e7db8923B0fC3F731a2607513064',
        STAKING_ADDR: '0x1e6fd3C2E11130a765bb81B6A1A0c6c1ea572310',
        ZFI_ADDR: '0x982634CADE06B9DF86900252c5Cde2592a77f13F',
        COORDINATOR_ADDR: '0xBEf90Fb37CfaA3ee2B062d7Dd01489e90eb5Fc99',
        BRIDGE_ADDR: '0x2242bE0FB356F8901c0278b3EDD85D66A2Ec4cA7',
      },
    };
  ...
  _getClusterRestorePath() {
    return path.join(__dirname, '.cluster-restore.json');
  }
  _saveClusterState() {
    try {
      const snapshot =
  ...
  _clearClusterState() {
    try {
      if (this.clusterState && typeof this.clusterState.reset === 'function') {
  ...
  async _verifyAndRestoreCluster() {
    ...
    try {
      ...
      const effectiveMembers = Array.isArray(onChainMembers) && onChainMembers.length
        ? onChainMembers
        : state.members;
...
[OK] Final multisig address: ${finalAddr}`);
      ...
      if (this.clusterState && typeof this.clusterState.update === 'function') {
        this.clusterState.update({ finalAddress: finalAddr, finalizationStartAt: Date.now() });
      }
